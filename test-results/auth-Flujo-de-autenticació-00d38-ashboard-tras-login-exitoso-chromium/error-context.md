...
- Name: auth.spec.ts >> Flujo de autenticación >> Login >> redirige al dashboard tras login exitoso
- Location: tests/e2e/auth.spec.ts:36:9
    ...
    - generic [ref=e5]:
      ...
      - generic [ref=e11]:
        - generic [ref=e12]:
          ...
          - textbox "tu@email.com" [active] [ref=e14]: test@kefy.com
        - generic [ref=e15]:
