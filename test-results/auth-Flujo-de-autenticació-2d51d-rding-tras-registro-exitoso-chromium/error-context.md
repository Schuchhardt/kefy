...
- Name: auth.spec.ts >> Flujo de autenticación >> Registro >> redirige al dashboard/onboarding tras registro exitoso
- Location: tests/e2e/auth.spec.ts:71:9
...
Received string:  "http://localhost:3097/es/register"
Timeout: 10000ms

Call log:
  - Expect "toHaveURL" with timeout 10000ms
    24 × unexpected value "http://localhost:3097/es/register"
...
- textbox "Mi Marca": Nuevo Usuario
- text: Email
- textbox "tu@email.com": Mi Empresa
- text: Contraseña
- textbox "Mínimo 8 caracteres"
